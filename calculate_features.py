...
def calc_distance_matrix_ghost(finalSeqs): #calculate distance matrix from the 1-step list
    l=len(finalSeqs)
    arr=np.zeros([l,l])
...
def calc_distance_matrix(finalSeqs): #calculate distance matrix from the 1-step list manually
    l=len(finalSeqs)
    arr=np.zeros([l,l])
